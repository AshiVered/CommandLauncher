...
class MainActivity : SimpleActivity(), FlingListener {
    ...
    private fun getDefaultAppPackages(appLaunchers: ArrayList<AppLauncher>) {
        ...
        try {
            appLaunchers.firstOrNull { it.packageName == "com.unicell.pangoandroid" }?.apply {
                val dialerIcon =
                    HomeScreenGridItem(
                        id = null,
                        left = 0,
                        ...
                        page = 0,
                        packageName = "com.unicell.pangoandroid",
                        activityName = "",
                        title = title,
                        type = ITEM_TYPE_ICON,
                        className = "",
        ...
        try {
            val defaultSMSMessengerPackage = "com.waze"
        ...
        try {
            ...
            val defaultBrowserPackage = "air.com.cellogroup.Cellopark"
        ...
        try {
            val potentialStores = arrayListOf(
                "com.android.settings", "io.github.huskydg.magisk", "com.aurora.store"
            )
        ...
        try {
            val defaultCameraPackage = "com.aurora.store"
